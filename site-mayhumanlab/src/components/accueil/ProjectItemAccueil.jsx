function ProjectsItemAccueil({ project }) {
    ...
    return (
        <li className="w-full rounded-lg lg:rounded-3xl h-2/3 pt-4 mb-8 relative">
            ...
            <div aria-hidden="true" className="bottom-0 absolute -z-10 inset-x-0 inset-y-4 lg:rounded-3xl blur-md bg-gradient-to-br from-amber-600 to-sky-800 opacity-50"></div>
