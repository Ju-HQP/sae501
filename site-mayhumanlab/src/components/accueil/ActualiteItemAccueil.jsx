...
function ActualiteItemAccueil({ actualite }) {
    ...
    return (
        <li className="w-full h-2/3 pt-4 mb-8 lg:m-0 lg:pt-0">
            ...
            <div className="p-6">
                <img src={actualite.image_a} className="object-cover h-44 w-full m-auto rounded-lg my-6" />
                <h3 className="font-jura text-3xl text-center mb-4">
                    {actualite.titre_a}
                </h3>
                <p className="mt-6 ">{formattedDate}</p>
                <p className="my-4  lg:leading-7">
