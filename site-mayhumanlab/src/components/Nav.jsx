                            ...
                            <ul className="text-lg flex justify-between items-center">
                                <li className="flex flex-col items-center relative hover:bg-slate-100 rounded">
                                    <span className="flex justify-between w-28">    
                                        <NavLink className={({isActive})=> isActive ? 'text-pink-600 underline underline-offset-8 py-2 px-4 ' : 'py-2 px-4  '} to="/" onMouseOver={() => setIsMenuOpen(true)} onMouseOut={() => setIsMenuOpen(false)}>Accueil</NavLink>
                                ...
                                <li className="my-3">
                                    <NavLink to='/agenda' className={({isActive})=> isActive ? 'text-pink-600 underline underline-offset-8 py-2 px-4  hover:bg-slate-100 rounded':'py-2 px-4  hover:bg-slate-100 rounded'}>Agenda</NavLink>
                                </li>
                                <li className="my-3">
                                    <NavLink to='/trombinoscope' className={({isActive})=> isActive ? 'text-pink-600 underline underline-offset-8 py-2 px-4  hover:bg-slate-100 rounded':'py-2 px-4  hover:bg-slate-100 rounded'}>Trombinoscope</NavLink>
                                </li>
                                <li className="my-3">
                                    <NavLink to='/gestion-du-site' className={({isActive})=> isActive ? 'text-pink-600 underline underline-offset-8 py-2 px-4  hover:bg-slate-100 rounded':'py-2 px-4  hover:bg-slate-100 rounded'}>Gestion du site</NavLink>
                                </li>
                                ...
                                {/**QUE POUR LES ADMINS */
                                    ...
                                    &&
                                    <li className="my-3">
                                        <NavLink to='/gestion-des-benevoles' className={({isActive})=> isActive ? 'text-pink-600 underline underline-offset-8 py-2 px-4  hover:bg-slate-100 rounded' : 'py-2 px-4  hover:bg-slate-100 rounded'}>Gestion des comptes</NavLink>
                                    </li>
                                }
