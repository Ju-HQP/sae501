    ...
    <>
      ...
      <main className="font-roboto leading-8 text-lg">
        ...
        <div className="flex flex-col items-center m-auto md:grid grid-cols-2 md:max-w-xl">
          <img
            src={userInfos.photo_b}
            className="w-32 h-32 object-cover rounded-full md:w-40 md:h-40 col-start-1 col-end-2 m-auto"
          />
          ...
          <div>
            <ul className="grid grid-cols-2 gap-3">
              {competence.map((comp, id) => (
                <li
                  key={id}
                  className="rounded-full px-4 py-1 bg-slate-300 text-center"
                >
                  {comp.nom_c}
                </li>
              ))}
          ...
          <div className="col-span-2 mt-8 md:text-end">
            <button
              className="secondary-btn-small mr-4"
